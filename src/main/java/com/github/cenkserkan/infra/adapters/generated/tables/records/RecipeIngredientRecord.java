...
public class RecipeIngredientRecord extends UpdatableRecordImpl<RecipeIngredientRecord> implements Record7<UUID, UUID, Integer, String, Integer, LocalDateTime, LocalDateTime> {
     ...
     */
    public void setWeightInGram(Integer value) {
        set(4, value);
    }
    ...
    @Override
    public Row7<UUID, UUID, Integer, String, Integer, LocalDateTime, LocalDateTime> valuesRow() {
    ...
    @Override
    public RecipeIngredientRecord value5(Integer value) {
    ...
    @Override
    public RecipeIngredientRecord values(UUID value1, UUID value2, Integer value3, String value4, Integer value5, LocalDateTime value6, LocalDateTime value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public RecipeIngredientRecord(UUID recipeId, UUID ingredientId, Integer quantity, String unit, Integer weightInGram, LocalDateTime createdAt, LocalDateTime updatedAt) {
        super(RecipeIngredient.RECIPE_INGREDIENT);
