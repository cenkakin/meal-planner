...
public class UserRecord extends UpdatableRecordImpl<UserRecord> implements Record6<UUID, LocalDateTime, LocalDateTime, String, String, String> {
    ...
    @Override
    public Row6<UUID, LocalDateTime, LocalDateTime, String, String, String> fieldsRow() {
        return (Row6) super.fieldsRow();
    }

    @Override
    public Row6<UUID, LocalDateTime, LocalDateTime, String, String, String> valuesRow() {
    ...
    @Override
    public UserRecord values(UUID value1, LocalDateTime value2, LocalDateTime value3, String value4, String value5, String value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UserRecord(UUID id, LocalDateTime createdAt, LocalDateTime updatedAt, String userName, String password, String email) {
        super(User.USER);
